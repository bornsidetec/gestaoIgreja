object FormImporta: TFormImporta
  ...
  Width = 361
  Height = 526
  Caption = 'Importa'#231#227'o Excel'
  Color = clBtnFace
  ...
  object ADOConn: TADOConnection
    ConnectionString = 
      'Provider=Microsoft.Jet.OLEDB.4.0;Data Source=D:\BornSide\cliente' +
      's\Banco\Bruno sistema.xls;Persist Security Info=False'
    LoginPrompt = False
  ...
  object OpenDialog: TOpenDialog
    Filter = 
      'Banco de Dados Excel (*.xlsx)|*.xlsx|Banco de Dados Excel (*.xls' +
      ')|*.xls'
    Left = 164
    Top = 40
  end
