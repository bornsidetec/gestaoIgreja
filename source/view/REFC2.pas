...
uses
  ...
  RxMemDS, DateUtils, Spin, RxGIF, Grids, DBGrids, CRGrid, Mask, rxToolEdit,
  MemDS, DBAccess, Uni, QRPDFFilt;

type
  TFormREFC2 = class(TForm)
    PanelFiltro: TPanel;
    PanelBotoes: TPanel;
    Label1: TLabel;
    ...
    RxMSubRDC: TRxMemoryData;
    RxMSubRDCDizimista1: TStringField;
    RxMSubRDCDizimista2: TStringField;
    RxMSubRDCDizimista3: TStringField;
    RxMSubRDCDizimista4: TStringField;
    RxMSubRDCDizimista5: TStringField;
    RxMSubRDCDizimista6: TStringField;
    RxMSubRDCDizimista7: TStringField;
    RxMSubRDCDizimista8: TStringField;
    RxMSubRDCDizimista9: TStringField;
    RxMSubRDCDizimista10: TStringField;
    RxMSubRDCDizimista11: TStringField;
    RxMSubRDCDizimista12: TStringField;
    RxMSubRDCDizimista13: TStringField;
    RxMSubRDCDizimista14: TStringField;
    RxMSubRDCDizimista15: TStringField;
    RxMSubRDCDizimista16: TStringField;
    RxMSubRDCDizimista17: TStringField;
    RxMSubRDCDizimista18: TStringField;
    RxMSubRDCDizimista19: TStringField;
    RxMSubRDCDizimista20: TStringField;
    RxMSubRDCDizimista21: TStringField;
    RxMSubRDCDizimista22: TStringField;
    RxMSubRDCDizimista23: TStringField;
    RxMSubRDCDizimista24: TStringField;
    RxMSubRDCDizimista25: TStringField;
    RxMSubRDCDizimo1: TCurrencyField;
    RxMSubRDCDizimo2: TCurrencyField;
    RxMSubRDCDizimo3: TCurrencyField;
    RxMSubRDCDizimo4: TCurrencyField;
    RxMSubRDCDizimo5: TCurrencyField;
    RxMSubRDCDizimo6: TCurrencyField;
    RxMSubRDCDizimo7: TCurrencyField;
    RxMSubRDCDizimo8: TCurrencyField;
    RxMSubRDCDizimo9: TCurrencyField;
    RxMSubRDCDizimo10: TCurrencyField;
    RxMSubRDCDizimo11: TCurrencyField;
    RxMSubRDCDizimo12: TCurrencyField;
    RxMSubRDCDizimo13: TCurrencyField;
    RxMSubRDCDizimo14: TCurrencyField;
    RxMSubRDCDizimo15: TCurrencyField;
    RxMSubRDCDizimo16: TCurrencyField;
    RxMSubRDCDizimo17: TCurrencyField;
    RxMSubRDCDizimo18: TCurrencyField;
    RxMSubRDCDizimo19: TCurrencyField;
    RxMSubRDCDizimo20: TCurrencyField;
    RxMSubRDCDizimo21: TCurrencyField;
    RxMSubRDCDizimo22: TCurrencyField;
    RxMSubRDCDizimo23: TCurrencyField;
    RxMSubRDCDizimo24: TCurrencyField;
    RxMSubRDCDizimo25: TCurrencyField;
    RxMSubRDCCheque1: TStringField;
    RxMSubRDCCheque2: TStringField;
    RxMSubRDCCheque3: TStringField;
    RxMSubRDCCheque4: TStringField;
    RxMSubRDCCheque5: TStringField;
    RxMSubRDCCheque6: TStringField;
    RxMSubRDCCheque7: TStringField;
    RxMSubRDCCheque8: TStringField;
    RxMSubRDCCheque9: TStringField;
    RxMSubRDCCheque10: TStringField;
    RxMSubRDCCheque11: TStringField;
    RxMSubRDCCheque12: TStringField;
    RxMSubRDCCheque13: TStringField;
    RxMSubRDCCheque14: TStringField;
    RxMSubRDCCheque15: TStringField;
    RxMSubRDCCheque16: TStringField;
    RxMSubRDCCheque17: TStringField;
    RxMSubRDCCheque18: TStringField;
    RxMSubRDCCheque19: TStringField;
    RxMSubRDCCheque20: TStringField;
    RxMSubRDCCheque21: TStringField;
    RxMSubRDCCheque22: TStringField;
    RxMSubRDCCheque23: TStringField;
    RxMSubRDCCheque24: TStringField;
    RxMSubRDCCheque25: TStringField;
    RxMSubRDCBanco1: TStringField;
    RxMSubRDCBanco2: TStringField;
    RxMSubRDCBanco3: TStringField;
    RxMSubRDCBanco4: TStringField;
    RxMSubRDCBanco5: TStringField;
    RxMSubRDCBanco6: TStringField;
    RxMSubRDCBanco7: TStringField;
    RxMSubRDCBanco8: TStringField;
    RxMSubRDCBanco9: TStringField;
    RxMSubRDCBanco10: TStringField;
    RxMSubRDCBanco11: TStringField;
    RxMSubRDCBanco12: TStringField;
    RxMSubRDCBanco13: TStringField;
    RxMSubRDCBanco14: TStringField;
    RxMSubRDCBanco15: TStringField;
    RxMSubRDCBanco16: TStringField;
    RxMSubRDCBanco17: TStringField;
    RxMSubRDCBanco18: TStringField;
    RxMSubRDCBanco19: TStringField;
    RxMSubRDCBanco20: TStringField;
    RxMSubRDCBanco21: TStringField;
    RxMSubRDCBanco22: TStringField;
    RxMSubRDCBanco23: TStringField;
    RxMSubRDCBanco24: TStringField;
    RxMSubRDCBanco25: TStringField;
    RxMSubRDCCodigo: TIntegerField;
    RxMSubRDCSeq: TIntegerField;
    RxMSubRDCIgrejaBairro: TStringField;
    RxMSubRDCCNPJ: TStringField;
    RxMSubRDCDia: TStringField;
    RxMSubRDCMes: TStringField;
    RxMSubRDCAno: TStringField;
    RxMSubRDCDizimos: TCurrencyField;
    RxMSubRDCDiaconos1: TStringField;
    RxMSubRDCDiaconos2: TStringField;
    RxMSubRDCTesoureiro: TStringField;
    RxMSubRDCTotalRDC: TCurrencyField;
    QRBand2: TQRBand;
    QRShape1: TQRShape;
    QRShape37: TQRShape;
    QRShape55: TQRShape;
    ...
    procedure RxMREFCAfterScroll(DataSet: TDataSet);
...
procedure TFormREFC2.BtnVisualizarClick(Sender: TObject);
begin
  ...
  RxMREFC.First;
  RxMRDC.SortOnFields('Codigo;Seq');
...
procedure TFormREFC2.EditAnoKeyPress(Sender: TObject; var Key: Char);
begin
  if not( key in ['0'..'9', #13, #8]) then
    key := #0;
end;

procedure TFormREFC2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  RxMREFC.Close;
  QryConfig.Close;
  FormREFC2 := nil;
...
procedure TFormREFC2.BtnSairClick(Sender: TObject);
begin
  Close;
end;

procedure TFormREFC2.QRDBText26Print(sender: TObject; var Value: String);
begin
  if Value = 'R$ 0,00' then
    Value := '';  
end;

procedure TFormREFC2.FormCreate(Sender: TObject);
begin
  EditAno.Text := IntToStr(YearOf(Date()));
end;

procedure TFormREFC2.BuscarDados;
var
  D, I, Seq : integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      RxMREFCCNPJ.AsString         := FormatFloat('########/####-##',FieldByName('CNPJ').AsFloat);
...
procedure TFormREFC2.RxMREFCAfterScroll(DataSet: TDataSet);
var
  i : Integer;
begin
  ...
  RxMSubRDC.Open;
  RxMRDC.First;
  while not RxMRDC.eof do
  begin
    if RxMRDCCodigo.AsInteger = RxMREFCCodigo.AsInteger then
    begin
      RxMSubRDC.Append;
      For i := 0 to RxMRDC.FieldCount - 1 do
        RxMSubRDC.Fields[i].Value := RxMRDC.Fields[i].Value;
      RxMSubRDC.Post;
    end;
    RxMRDC.Next;
  end;
...
procedure TFormREFC2.FormActivate(Sender: TObject);
begin
  QryConfig.Open;
end;
