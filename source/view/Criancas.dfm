object FormCriancas: TFormCriancas
  Left = 296
  Top = 220
  ...
  object QryCriancas: TUniQuery
    Connection = DMJetro.Conn
    SQL.Strings = (
      'select * from Criancas'
      'where codigo = -1')
    DMLRefresh = True
    BeforeInsert = QryCriancasBeforeInsert
    BeforeEdit = QryCriancasBeforeEdit
    BeforePost = QryCriancasBeforePost
    AfterPost = QryCriancasAfterPost
    AfterCancel = QryCriancasAfterCancel
    BeforeDelete = QryCriancasBeforeDelete
    OnCalcFields = QryCriancasCalcFields
    OnNewRecord = QryCriancasNewRecord
    Left = 632
    Top = 96
    object QryCriancasCodigo: TIntegerField
      FieldName = 'Codigo'
      ProviderFlags = [pfInWhere]
      ReadOnly = True
    end
    object QryCriancasNome: TStringField
      FieldName = 'Nome'
      Required = True
      Size = 50
    end
    object QryCriancasDataNascimento: TDateTimeField
      DisplayLabel = 'Data de Nascimento'
      FieldName = 'DataNascimento'
    end
    object QryCriancasSexo: TStringField
      FieldName = 'Sexo'
      Required = True
      FixedChar = True
      Size = 1
    end
    object QryCriancasEndRua: TStringField
      DisplayLabel = 'Logradouro'
      FieldName = 'EndRua'
      Size = 50
    end
    object QryCriancasEndNumero: TStringField
      DisplayLabel = 'N'#250'mero'
      FieldName = 'EndNumero'
      Size = 6
    end
    object QryCriancasEndBairro: TStringField
      DisplayLabel = 'Bairro'
      FieldName = 'EndBairro'
      Size = 50
    end
    object QryCriancasEndComplemento: TStringField
      FieldName = 'EndComplemento'
      Size = 30
    end
    object QryCriancasEndCidade: TStringField
      DisplayLabel = 'Cidade'
      FieldName = 'EndCidade'
      Size = 50
    end
    object QryCriancasEndEstado: TStringField
      DisplayLabel = 'Estado'
      FieldName = 'EndEstado'
      Size = 2
    end
    object QryCriancasEndCep: TStringField
      DisplayLabel = 'CEP'
      FieldName = 'EndCep'
      Size = 8
    end
    object QryCriancasFoneResid: TStringField
      FieldName = 'FoneResid'
      EditMask = '!\(99\)9999-9999;0;_'
      Size = 10
    end
    object QryCriancasFoneCelular: TStringField
      FieldName = 'FoneCelular'
      EditMask = '!\(99\)9999-9999;0;_'
      Size = 10
    end
    object QryCriancasStatus: TIntegerField
      FieldName = 'Status'
    end
    object QryCriancasUserInsert: TIntegerField
      FieldName = 'UserInsert'
    end
    object QryCriancasDataInsert: TDateTimeField
      FieldName = 'DataInsert'
    end
    object QryCriancasUserUpdate: TIntegerField
      FieldName = 'UserUpdate'
    end
    object QryCriancasDataUpdate: TDateTimeField
      FieldName = 'DataUpdate'
    end
    object QryCriancasFILIACAOPAI: TIntegerField
      FieldName = 'FILIACAOPAI'
    end
    object QryCriancasFILIACAOMAE: TIntegerField
      FieldName = 'FILIACAOMAE'
    end
    object QryCriancasNomePai: TStringField
      FieldKind = fkCalculated
      FieldName = 'NomePai'
      Size = 50
      Calculated = True
    end
    object QryCriancasNomeMae: TStringField
      FieldKind = fkCalculated
      FieldName = 'NomeMae'
      Size = 50
      Calculated = True
