object FormFornecedores: TFormFornecedores
  ...
  object QryFornecedores: TUniQuery
    Connection = DMJetro.Conn
    SQL.Strings = (
      'select * from Fornecedores'
      'where codigo = -1')
    DMLRefresh = True
    BeforeInsert = QryFornecedoresBeforeInsert
    BeforeEdit = QryFornecedoresBeforeEdit
    BeforePost = QryFornecedoresBeforePost
    AfterPost = QryFornecedoresAfterPost
    AfterCancel = QryFornecedoresAfterCancel
    BeforeDelete = QryFornecedoresBeforeDelete
    ...
    object QryFornecedoresTipo: TIntegerField
      FieldName = 'Tipo'
      Required = True
    end
    object QryFornecedoresCNPJ_CPF: TStringField
    ...
    object QryFornecedoresIE_RG: TStringField
      FieldName = 'IE_RG'
      Size = 12
    end
    ...
    object QryFornecedoresEndRua: TStringField
      DisplayLabel = 'Logradouro'
      FieldName = 'EndRua'
      Size = 50
    end
    object QryFornecedoresEndNumero: TStringField
      DisplayLabel = 'N'#250'mero'
      FieldName = 'EndNumero'
      Size = 6
    end
    object QryFornecedoresEndBairro: TStringField
      DisplayLabel = 'Bairro'
      FieldName = 'EndBairro'
      Size = 50
    end
    object QryFornecedoresEndComplemento: TStringField
      FieldName = 'EndComplemento'
      Size = 30
    end
    object QryFornecedoresEndCidade: TStringField
      DisplayLabel = 'Cidade'
      FieldName = 'EndCidade'
      Size = 50
    end
    object QryFornecedoresEndEstado: TStringField
      DisplayLabel = 'Estado'
      FieldName = 'EndEstado'
      Size = 2
    end
    object QryFornecedoresEndCep: TStringField
      DisplayLabel = 'CEP'
      FieldName = 'EndCep'
      Size = 8
    end
    object QryFornecedoresFoneResid: TStringField
      FieldName = 'FoneResid'
      EditMask = '!\(99\)9999-9999;0;_'
      Size = 10
    end
    object QryFornecedoresFoneCelular: TStringField
      FieldName = 'FoneCelular'
      EditMask = '!\(99\)9999-9999;0;_'
      Size = 10
    end
    object QryFornecedoresStatus: TIntegerField
      FieldName = 'Status'
    end
    object QryFornecedoresUserInsert: TIntegerField
      FieldName = 'UserInsert'
    end
    object QryFornecedoresDataInsert: TDateTimeField
      FieldName = 'DataInsert'
    end
    object QryFornecedoresUserUpdate: TIntegerField
      FieldName = 'UserUpdate'
    end
    object QryFornecedoresDataUpdate: TDateTimeField
      FieldName = 'DataUpdate'
    end
    object QryFornecedoresDescTipo: TStringField
