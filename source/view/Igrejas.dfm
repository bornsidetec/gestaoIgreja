object FormIgrejas: TFormIgrejas
  Left = 383
  Top = 202
  ...
  object PageControl: TPageControl
    ...
    Width = 622
    Height = 240
    ActivePage = TabSheetProgramacao
    Align = alClient
    TabOrder = 0
    ...
    object TabSheetManutencao: TTabSheet
      ...
      object PanelDados: TPanel
        ...
        object DBEdit5: TDBEdit
          ...
          Height = 21
          CharCase = ecUpperCase
          DataField = 'Superintendente'
          DataSource = Ds
          TabOrder = 6
        end
        object DBCheckBoxSede: TDBCheckBox
          Left = 152
          Top = 28
          Width = 97
          Height = 17
          Caption = 'Sede Regional'
          DataField = 'Sede'
          DataSource = Ds
          TabOrder = 1
          ValueChecked = '1'
    ...
    object TabSheetProgramacao: TTabSheet
      Caption = 'Programa'#231#227'o Semanal'
      ImageIndex = 1
    ...
    object TabSheetConfiguracoes: TTabSheet
      ...
      object DBNavigatorConfig: TDBNavigator
        Left = 508
        Top = 16
        Width = 96
        Height = 25
  ...
  object QryIgrejas: TUniQuery
    ...
    SQL.Strings = (
      ...
      'where codigo = 1')
    DMLRefresh = True
    BeforeInsert = QryIgrejasBeforeInsert
    BeforeEdit = QryIgrejasBeforeEdit
    BeforePost = QryIgrejasBeforePost
    AfterPost = QryIgrejasAfterPost
    AfterCancel = QryIgrejasAfterCancel
    BeforeDelete = QryIgrejasBeforeDelete
    OnCalcFields = QryIgrejasCalcFields
    OnNewRecord = QryIgrejasNewRecord
    Left = 400
    Top = 56
    object QryIgrejasCodigo: TIntegerField
      FieldName = 'Codigo'
    ...
    object QryIgrejasPastor: TIntegerField
      DisplayLabel = 'C'#243'digo Pastor'
      FieldName = 'Pastor'
      Required = True
    end
    ...
    object QryIgrejasEndComplemento: TStringField
    ...
    object QryIgrejasFoneCelular: TStringField
      FieldName = 'FoneCelular'
      EditMask = '!\(99\)9999-9999;0;_'
      Size = 10
    end
    object QryIgrejasFoneResid: TStringField
      FieldName = 'FoneResid'
      EditMask = '!\(99\)9999-9999;0;_'
      Size = 10
    end
  ...
  object QryProgramacao: TUniQuery
    Connection = DMJetro.Conn
    SQL.Strings = (
    ...
    DMLRefresh = True
    BeforeInsert = QryProgramacaoBeforeInsert
    BeforeEdit = QryProgramacaoBeforeEdit
    BeforePost = QryProgramacaoBeforePost
    AfterPost = QryProgramacaoAfterPost
    AfterCancel = QryProgramacaoAfterPost
    BeforeDelete = QryProgramacaoBeforeDelete
    OnCalcFields = QryProgramacaoCalcFields
    OnNewRecord = QryProgramacaoNewRecord
    Left = 292
    Top = 57
    ParamData = <
      item
    ...
    object QryProgramacaoCodigo: TIntegerField
      FieldName = 'Codigo'
      ProviderFlags = [pfInWhere]
      ReadOnly = True
    end
    object QryProgramacaoIgreja: TIntegerField
      FieldName = 'Igreja'
    end
    object QryProgramacaoDiaSemana: TIntegerField
      DisplayLabel = 'Dia da Semana'
      FieldName = 'DiaSemana'
      Required = True
    end
    object QryProgramacaoHora: TStringField
    ...
    object QryProgramacaoDescricao: TStringField
      DisplayLabel = 'Descri'#231#227'o'
      FieldName = 'Descricao'
      Required = True
      Size = 50
    end
    object QryProgramacaoAtivo: TStringField
      FieldName = 'Ativo'
      Size = 1
    end
    object QryProgramacaoUserInsert: TIntegerField
      FieldName = 'UserInsert'
    end
    object QryProgramacaoDataInsert: TDateTimeField
      FieldName = 'DataInsert'
    end
    object QryProgramacaoUserUpdate: TIntegerField
      FieldName = 'UserUpdate'
    end
    object QryProgramacaoDataUpdate: TDateTimeField
      FieldName = 'DataUpdate'
    end
    object QryProgramacaoDescDiaSemana: TStringField
      FieldKind = fkCalculated
      FieldName = 'DescDiaSemana'
      Size = 10
      Calculated = True
  ...
  object QryConfig: TUniQuery
    ...
    AfterPost = QryConfigAfterCancel
