object FormCelulas: TFormCelulas
  Left = 355
  Top = 141
  ...
  object PageControl: TPageControl
      ...
      object PanelGrid: TPanel
        ...
        object DBGrid: TRxDBGrid
          ...
          Columns = <
            ...
            item
              Expanded = False
              FieldName = 'NomeAuxiliar'
              Width = 244
              Visible = True
            end
            item
              Expanded = False
              FieldName = 'NomeAnfitriao'
              Width = 264
              Visible = True
            end
            item
    ...
    object TabSheetManutencao: TTabSheet
      ...
      object PanelDados: TPanel
        ...
        object SpdBtnSetores: TSpeedButton
          Left = 84
          Top = 103
          Width = 23
          Height = 22
        ...
        object SpdBtnLider: TSpeedButton
          Left = 84
          Top = 183
          Width = 23
          Height = 22
        ...
        object SpdBtnAuxiliar: TSpeedButton
          Left = 84
          Top = 223
          Width = 23
          Height = 22
        ...
        object SpdBtnAnfitriao: TSpeedButton
          Left = 84
          Top = 263
          Width = 23
          Height = 22
        ...
        object RxDBCboDiaSemana: TRxDBComboBox
          Left = 104
          Top = 144
          Width = 81
          Height = 21
  ...
  object PanelBanner: TPanel
    ...
    object Label7: TLabel
      ...
      Width = 205
      Height = 24
      Caption = 'Cadastro de C'#233'lulas'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clWhite
      Font.Height = -21
      Font.Name = 'Arial'
  ...
  object QryCelulas: TUniQuery
    Connection = DMJetro.Conn
    SQL.Strings = (
      'select * from Celulas'
      'where codigo = -1')
    DMLRefresh = True
    BeforeInsert = QryCelulasBeforeInsert
    BeforeEdit = QryCelulasBeforeEdit
    BeforePost = QryCelulasBeforePost
    AfterPost = QryCelulasAfterPost
    AfterCancel = QryCelulasAfterCancel
    BeforeDelete = QryCelulasBeforeDelete
    OnCalcFields = QryCelulasCalcFields
    Left = 384
    Top = 96
    object QryCelulasCodigo: TIntegerField
      FieldName = 'Codigo'
      ProviderFlags = [pfInWhere]
      ReadOnly = True
    end
    object QryCelulasNome: TStringField
      FieldName = 'Nome'
      Required = True
      Size = 100
    end
    object QryCelulasEndRua: TStringField
      DisplayLabel = 'Logradouro'
      FieldName = 'EndRua'
      Size = 50
    end
    object QryCelulasEndNumero: TStringField
      DisplayLabel = 'N'#250'mero'
      FieldName = 'EndNumero'
      Size = 6
    end
    object QryCelulasEndBairro: TStringField
      DisplayLabel = 'Bairro'
      FieldName = 'EndBairro'
      Size = 50
    end
    object QryCelulasEndComplemento: TStringField
      FieldName = 'EndComplemento'
      Size = 30
    end
    object QryCelulasEndCidade: TStringField
      DisplayLabel = 'Cidade'
      FieldName = 'EndCidade'
      Size = 50
    end
    object QryCelulasEndEstado: TStringField
      DisplayLabel = 'Estado'
      FieldName = 'EndEstado'
      Size = 2
    end
    object QryCelulasEndCep: TStringField
      DisplayLabel = 'CEP'
      FieldName = 'EndCep'
      Size = 8
    end
    object QryCelulasUserInsert: TIntegerField
      FieldName = 'UserInsert'
    end
    object QryCelulasDataInsert: TDateTimeField
      FieldName = 'DataInsert'
    end
    object QryCelulasUserUpdate: TIntegerField
      FieldName = 'UserUpdate'
    end
    object QryCelulasDataUpdate: TDateTimeField
      FieldName = 'DataUpdate'
    end
    object QryCelulasLOGO: TMemoField
      FieldName = 'LOGO'
      BlobType = ftMemo
    end
    object QryCelulasSETOR: TIntegerField
      FieldName = 'SETOR'
      Required = True
    end
    object QryCelulasLIDER: TIntegerField
      FieldName = 'LIDER'
      Required = True
    end
    object QryCelulasAUXILIAR: TIntegerField
      FieldName = 'AUXILIAR'
      Required = True
    end
    object QryCelulasANFITRIAO: TIntegerField
      FieldName = 'ANFITRIAO'
      Required = True
    end
    object QryCelulasDIASEMANA: TIntegerField
      FieldName = 'DIASEMANA'
    end
    object QryCelulasHORA: TStringField
      DisplayLabel = 'Hor'#225'rio'
      FieldName = 'HORA'
      EditMask = '##:##'
      Size = 5
    end
    object QryCelulasINAUGURACAO: TDateTimeField
      FieldName = 'INAUGURACAO'
    end
    object QryCelulasOBSERVACAO: TMemoField
      FieldName = 'OBSERVACAO'
      BlobType = ftMemo
    end
    object QryCelulasNomeSetor: TStringField
      DisplayLabel = 'Setor'
    ...
    object QryCelulasNomeLider: TStringField
      DisplayLabel = 'L'#237'der'
      FieldKind = fkCalculated
      FieldName = 'NomeLider'
      Size = 50
      Calculated = True
    end
    object QryCelulasNomeAuxiliar: TStringField
      DisplayLabel = 'Auxiliar'
      FieldKind = fkCalculated
      FieldName = 'NomeAuxiliar'
      Size = 50
      Calculated = True
    end
    object QryCelulasNomeAnfitriao: TStringField
      DisplayLabel = 'Anfitri'#227'o'
      FieldKind = fkCalculated
      FieldName = 'NomeAnfitriao'
      Size = 50
      Calculated = True
    end
    object QryCelulasDia: TStringField
