object FormAvisos: TFormAvisos
  ...
  Caption = 'Impress'#227'o de Avisos (Eventos)'
  ClientHeight = 158
  ClientWidth = 280
  Color = clBtnFace
    ...
    object QuickRep: TQuickRep
      ...
      object PageHeaderBand1: TQRBand
        ...
        object QRLabelRel: TQRLabel
          ...
          AutoSize = True
          AutoStretch = False
          Caption = 'RELAT'#211'RIO DE AVISOS - Eventos'
          Color = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -13
      ...
      object QRGroup1: TQRGroup
        ...
        object QRMemoDiaSemana: TQRMemo
          Left = 166
          Top = 1
          Width = 105
          Height = 24
        ...
        object QRMemoDescricao: TQRMemo
          Left = 560
          Top = 1
          Width = 485
          Height = 24
      ...
      object ColumnHeaderBand1: TQRBand
        ...
        object QRLabel14: TQRLabel
          ...
          AutoSize = True
          AutoStretch = False
          Caption = '[DEPARTAMENTOS] - Grupos Envolvidos ao Evento'
          Color = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
          Font.Height = -19
  ...
  object RxM: TRxMemoryData
    ...
    object RxMDescricao: TStringField
      FieldName = 'Descricao'
      Size = 50
    end
    ...
    object RxMHora: TStringField
      FieldName = 'Hora'
      Size = 5
    end
    object RxMTipoEvento: TStringField
      FieldName = 'TipoEvento'
      Size = 50
    end
    object RxMDepto: TStringField
      FieldName = 'Depto'
      Size = 50
    end
    object RxMDiaSemana: TStringField
  ...
  object RxMProgramacao: TRxMemoryData
    FieldDefs = <>
    Left = 208
    Top = 64
    object RxMProgramacaoHora: TStringField
      FieldName = 'Hora'
      Size = 5
    end
    object RxMProgramacaoDescricao: TStringField
      FieldName = 'Descricao'
      Size = 50
    end
    object RxMProgramacaoDescDiaSemana: TStringField
