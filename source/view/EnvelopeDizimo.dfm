object FormEnvelopeDizimo: TFormEnvelopeDizimo
  Left = 278
  Top = 199
  Width = 697
  Height = 512
  Caption = 'FormEnvelopeDizimo'
  Color = clBtnFace
    ...
    object RLBand2: TRLBand
      ...
      object RLMemo1: TRLMemo
        ...
        Lines.Strings = (
            ...
            'Trazei todos os d'#237'zimos '#224' casa do tesouro, para que haja mantime' +
            'nto na minha casa, e provai-me nisto, diz o Senhor dos Ex'#233'rcitos' +
            ', se eu n'#227'o vos abrir as janelas do c'#233'u, e n'#227'o derramar sobre v'#243 +
            's b'#234'n'#231#227'o sem medida. Ml 3.10, 11 e 12')
        ParentFont = False
      end
