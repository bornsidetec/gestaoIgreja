object FormEnvelopeOfertaEspecial: TFormEnvelopeOfertaEspecial
  Left = 278
  Top = 199
  Width = 697
  Height = 512
  Caption = 'FormEnvelopeOfertaEspecial'
  Color = clBtnFace
    ...
    object RLBand2: TRLBand
      ...
      object RLMemo1: TRLMemo
        ...
        Lines.Strings = (
            ...
            'Ora, aquele que d'#225' a semente ao que semeia, tamb'#233'm vos d'#234' p'#227'o pa' +
            'ra comer, e multiplique a vossa sementeira, e aumente os frutos ' +
            'da vossa justi'#231'a. 2 Cor'#237'ntios 9:10')
        ParentFont = False
      end
