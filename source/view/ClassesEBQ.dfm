object FormClassesEBQ: TFormClassesEBQ
  Left = 314
  Top = 225
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Cadastro de Classes - EBQ'
  ClientHeight = 311
  ClientWidth = 528
  Color = clBtnFace
  ...
  object PageControl: TPageControl
    ...
    object TabSheetManutencao: TTabSheet
      ...
      object PanelDados: TPanel
        ...
        object SpdBtnCategorias: TSpeedButton
          Left = 84
          Top = 63
          Width = 23
          Height = 22
  ...
  object QryClasses: TUniQuery
    Connection = DMJetro.Conn
    SQL.Strings = (
      'select * from Classes'
      'where codigo = -1')
    DMLRefresh = True
    BeforeInsert = QryClassesBeforeInsert
    BeforeEdit = QryClassesBeforeEdit
    BeforePost = QryClassesBeforePost
    AfterPost = QryClassesAfterPost
    AfterCancel = QryClassesAfterCancel
    BeforeDelete = QryClassesBeforeDelete
    OnCalcFields = QryClassesCalcFields
    Left = 232
    object QryClassesCodigo: TIntegerField
      FieldName = 'Codigo'
      ProviderFlags = [pfInWhere]
      ReadOnly = True
    end
    object QryClassesCategoria: TIntegerField
    ...
    object QryClassesCapacidade: TIntegerField
      FieldName = 'Capacidade'
    end
    object QryClassesIdadeInicial: TIntegerField
      FieldName = 'IdadeInicial'
    end
    object QryClassesIdadeFinal: TIntegerField
      FieldName = 'IdadeFinal'
    end
    object QryClassesUserInsert: TIntegerField
      FieldName = 'UserInsert'
    end
    object QryClassesDataInsert: TDateTimeField
      FieldName = 'DataInsert'
    end
    object QryClassesUserUpdate: TIntegerField
      FieldName = 'UserUpdate'
    end
    object QryClassesDataUpdate: TDateTimeField
      FieldName = 'DataUpdate'
    end
    object QryClassesDescCategoria: TStringField
