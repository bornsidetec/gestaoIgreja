...
type
  TFormPreImpCriancas = class(TForm)
    QuickRep: TQuickRep;
    DetailBand1: TQRBand;
    QRShape1: TQRShape;
    QRShape5: TQRShape;
...
var
  FormPreImpCriancas: TFormPreImpCriancas;

implementation

{$R *.dfm}

procedure TFormPreImpCriancas.FormCreate(Sender: TObject);
begin
  QryConfig.Open;
  Rx.Open;
  Rx.Append;
...
procedure TFormPreImpCriancas.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  QryConfig.Close;
  Rx.Close;
  FormPreImpCriancas := nil;
  Action := caFree;
end;
