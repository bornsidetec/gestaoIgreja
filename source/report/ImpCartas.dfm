object FormImpCartas: TFormImpCartas
  Left = 314
  Top = 155
  ...
  object PanelFiltro: TPanel
    ...
    object SpdBtnCartas: TSpeedButton
      Left = 68
      Top = 71
      Width = 23
      Height = 22
    ...
    object EditCarta: TEdit
      ...
      MaxLength = 8
      TabOrder = 2
      OnEnter = EditCartaEnter
      OnExit = EditCartaExit
      OnKeyDown = EditCartaKeyDown
      OnKeyPress = EditCartaKeyPress
    end
    object RLReport1: TRLReport
      ...
      object RLBand2: TRLBand
        ...
        object RLLabel2: TRLLabel
          ...
          Height = 15
          Alignment = taCenter
          Caption = 'CRUZADA NACIONAL DE EVANGELIZA'#199#195'O'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          Font.Name = 'Calibri'
      ...
      object RLBand3: TRLBand
        ...
        object RLLabel3: TRLLabel
          ...
          Alignment = taCenter
          Caption = 
            '"Jesus Cristo '#233' o mesmo ontem, hoje e ser'#225' enternamente" - Hebre' +
            'us 13.8'
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Height = -16
    ...
    object GroupBox1: TGroupBox
      ...
      Width = 225
      Height = 41
      Caption = 'Etiquetas de Endere'#231'o'
      TabOrder = 5
    ...
    object QuickRep: TQuickRep
      ...
      object PageFooterBand1: TQRBand
        ...
        object QRLabel3: TQRLabel
          ...
          AutoStretch = False
          Caption = 
            '"JESUS CRISTO '#201' O MESMO ONTEM, HOJE E SER'#193' ETERNAMENTE". Hebreus' +
            ' 13.8'
          Color = clWhite
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
  ...
  object RxMem: TRxMemoryData
    ...
    Left = 344
    Top = 152
    object RxMemConteudo: TMemoField
      FieldName = 'Conteudo'
      BlobType = ftMemo
    end
  end
  ...
  object RxMemEndereco: TRxMemoryData
    FieldDefs = <>
    Left = 344
    Top = 184
    object RxMemEnderecoNome: TStringField
      FieldName = 'Nome'
      Size = 50
    end
    object RxMemEnderecoEndRua: TStringField
      FieldName = 'EndRua'
      Size = 50
    end
    object RxMemEnderecoEndNumero: TStringField
      FieldName = 'EndNumero'
      Size = 6
    end
    object RxMemEnderecoEndComplemento: TStringField
      FieldName = 'EndComplemento'
      Size = 30
    end
    object RxMemEnderecoEndBairro: TStringField
      FieldName = 'EndBairro'
      Size = 50
    end
    object RxMemEnderecoCidadeEstado: TStringField
      FieldName = 'CidadeEstado'
      Size = 53
    end
    object RxMemEnderecoEndCep: TStringField
      FieldName = 'EndCep'
      Size = 9
    end
  end
